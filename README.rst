...
2. Get the code::
    ...
    $ git clone ssh://git@bitbucket.org/maykinmedia/modelbouwdag.git
    $ cd modelbouwdag
...
``src/modelbouwdag/conf/local.py``. You can base this file on
...
Note that your wsgi script in ``src/modelbouwdag/wsgi.py already
